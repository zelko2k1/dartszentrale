  ...
  return (
    <div style={{ padding: isPhone ? '18px 14px' : '28px 32px', maxWidth: 980, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <button onClick={() => s.startTrain()} style={{ display: 'flex', alignItems: 'center', gap: 10, background: mode.color, border: 'none', color: 'var(--accent-fg)', padding: '14px 30px', borderRadius: 'var(--radius-md)', fontSize: 16, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit', boxShadow: `0 8px 24px color-mix(in srgb, ${mode.color} 28%, transparent)` }}>
