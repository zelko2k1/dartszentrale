    ...
    <div style={{ padding: '28px 32px', maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20, marginBottom: 22 }}>
        <div>
          ...
          <h1 style={{ margin: 0, fontSize: 27, fontWeight: 800, letterSpacing: '-.02em' }}>{tr.dashboard.usersRights}</h1>
          <p style={{ margin: '6px 0 0', fontSize: 14, color: 'var(--text-3)', maxWidth: 560 }}>{tr.users.subtitle}</p>
        </div>
