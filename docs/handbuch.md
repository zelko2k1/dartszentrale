...
> **Du willst die App erst aufsetzen (eigener Server)?** → Das steht in
> [`cloud-anleitung.md`](cloud-anleitung.md) (Einkaufsliste, Kosten, Schritt für
> Schritt) und [`../pocketbase/COOLIFY-SETUP.md`](../pocketbase/COOLIFY-SETUP.md).
