...
- `pocketbase/` mit:
  - **allen `.mjs`-Skripten** (`provision.mjs`, `demo-seed.mjs`,
...
node demo-seed.mjs    # Beispieldaten „Dartverein Demo"
```
...
```bash
node demo-seed.mjs      # „Dartverein Demo": 20 Mitglieder, 2 Mannschaften, 2 Ligen + Spielplan
