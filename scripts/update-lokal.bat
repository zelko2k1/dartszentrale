@echo off
chcp 65001 >nul
title DartsZentrale aktualisieren (lokal)
...
if errorlevel 1 ( echo [DartsZentrale] Node.js fehlt: https://nodejs.org & pause & exit /b 1 )
...
echo.
echo [DartsZentrale] Fertig. App neu starten:  start-lokal.bat
